...
export async function POST(req: Request) {
  try {
    ...
    <div style="font-family: Helvetica, Arial, sans-serif; max-width: 700px; margin: 0 auto; background-color: #ffffff; color: ${textDark}; padding: 40px; border: 1px solid #e4e4e7; border-radius: 16px;">
        ...
        <p style="margin: 0; color: ${primaryBlue}; font-size: 28px; font-weight: bold; letter-spacing: -1px;">MAIZTROS BI - REPORTE DE RESULTADOS</p>
        ...
        <div style="margin-top: 25px; background-color: #fff1f2; padding: 20px; border-radius: 12px; border: 1px solid #fecaca;">
        ...
        <div style="margin-top: 40px; border-top: 2px solid #e4e4e7; padding-top: 30px;">
            ...
            <table style="width: 100%; border-collapse: collapse; font-size: 11px; text-align: left;">
                ...
                ${audit.map((a:any) => {
                    ...
                    const cajerosStr = Array.isArray(a.cajero) ? a.cajero.join(', ') : (a.cajero || 'N/A');
                    return `
                    <tr style="border-bottom: 1px solid #e2e8f0;">
                        <td style="padding: 10px 5px; color:#71717a;">${day}/${month}</td>
                        <td style="padding: 10px 5px; font-weight:bold;">${cajerosStr}</td>
    ...
    if (type === 'daily') {
        ...
        <div style="font-family: Helvetica, Arial, sans-serif; max-width: 650px; margin: 0 auto; background-color: #ffffff; color: #18181b; padding: 40px; border: 1px solid #e4e4e7; border-radius: 16px;">
            ...
            <div style="background-color: #f8fafc; padding: 20px; border-radius: 12px; margin-top: 30px; border-left: 4px solid #3b82f6;">
                ...
                <p style="margin: 5px 0; font-size: 14px; color: #6366f1;"><strong>Ticket Promedio (Upsell):</strong> $${ticketPromedio.toFixed(2)} por orden</p>
            </div>
            ...
            <div style="background-color: #f0fdf4; padding: 25px; border-radius: 12px; margin-top: 25px; border: 1px solid #bbf7d0;">
                ...
                <div style="margin-top: 15px; padding-top: 15px; border-top: 2px dashed #86efac;">
                    <p style="margin: 0; display: flex; justify-content: space-between; font-size: 15px; color: #374151;"><span>Esperado en Caja:</span> <b>$${esperadoEnCaja.toFixed(2)}</b></p>
                    <p style="margin: 8px 0 0 0; display: flex; justify-content: space-between; font-size: 20px; font-weight: bold;"><span>Cajero Reportó:</span> <b>$${(lastShift.reportedCash || 0).toFixed(2)}</b></p>
                </div>
